...
* **能量来源**：**糖酵解（glycolysis）**（RBC **无线粒体**）
  ...
  * 葡萄糖→ATP→**Na⁺泵**维持**离子分布**、**细胞体积**与**双凹形态**
* **计数**
...
* **原料（Materials）**
  ...
  * **日需铁 20–30 mg**（实际**吸收约 1 mg/d**），**95%** 来自**体内循环利用**
...
* **成熟因子（Maturation factors）**
  ...
  * **内因子（Intrinsic factor，胃壁细胞分泌）**：**回肠吸收 VitB12 必需**；缺乏时 **VitB12 吸收仅约 1/50**
* **常见贫血类型**
...
* **EPO（促红细胞生成素）调控**
  ...
  * **作用**：促进**原红细胞**由干细胞产生；**加速各红细胞阶段通过**，**提高 RBC 生成速度**
...
3. **聚集（Aggregation）**
   ...
   * **促聚集（Ca²⁺↑，cAMP↓）**：**ADP、肾上腺素（Epi）、5-HT、组胺、胶原、凝血酶、TXA₂**；**病理性**：**细菌、病毒、免疫复合物、某些药物**
