...
* **人体微生物组（microbiome）**：病毒组（virome）、细菌组（bacteriome）、古菌组（archaeome）、真菌组（mycobiome）。
* **医学意义（以细菌群为例）**：
...
* **代谢副产物**：发酵**酸**、**气体**致组织损伤
* **组织破坏性酶**：透明质酸酶（hyaluronidase）、DNA酶（DNases）、胶原酶（collagenase）等
...
* **持续性感染（persistent infection）**：
  ...
  * **潜伏感染（latent）**：病毒以“隐藏形式”长期存在；特定条件下**激活复燃**
...
* 将“病原体-宿主-环境”三角与**感染链**要素对应记忆，临床题目按**进入途径×传播方式×宿主状态**快速定位。
* 细菌外/内毒素对比表是**高频考点**；结合**TLR4-CD14**通路与**细胞因子风暴**理解脓毒性休克。
* 系统性真菌多为**二态性**、**吸入获得**、**地理限布**且可累及**免疫正常人**，常设与**结核**的鉴别题。
* 病毒持续感染三分法（潜伏/慢性/迟发）结合**产生/不产生病毒**与**是否细胞裂解**框架记忆。
